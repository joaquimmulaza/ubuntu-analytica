...
const ContactSection = () => {
  return (
    <section id="contactos" className="py-24 bg-midnight-black text-white">
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {/* Left Column - Form */}
          <motion.div
            className="bg-midnight-black/80 p-8 rounded-neon border border-soft-neon-glow/30 backdrop-blur-neon shadow-glow-soft"
          ...
          >
            ...
            <p className="text-soft-neon-glow/70 mb-8 text-sm font-body">
            ...
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" className="w-full bg-midnight-black/60 border border-soft-neon-glow/30 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-electric-blue focus:shadow-glow-soft transition-all font-body" />
                </div>
                <div>
                  <label className="block text-xs font-body font-semibold text-soft-neon-glow/70 mb-2">Email *</label>
                  <input type="email" className="w-full bg-midnight-black/60 border border-soft-neon-glow/30 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-electric-blue focus:shadow-glow-soft transition-all font-body" />
                </div>
              </div>
              ...
              <div>
                ...
                <input type="tel" className="w-full bg-midnight-black/60 border border-soft-neon-glow/30 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-electric-blue focus:shadow-glow-soft transition-all font-body" />
              </div>

              <div>
                <label className="block text-xs font-body font-semibold text-soft-neon-glow/70 mb-2">Mensagem *</label>
                <textarea rows="4" className="w-full bg-midnight-black/60 border border-soft-neon-glow/30 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-electric-blue focus:shadow-glow-soft transition-all font-body"></textarea>
              </div>
          ...
          <div className="flex flex-col gap-8">
            ...
            {/* Info Card */}
            <motion.div
              className="bg-midnight-black/80 p-8 rounded-neon border border-soft-neon-glow/30 backdrop-blur-neon shadow-glow-soft flex-1"
              initial={{ opacity: 0, x: 50 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <div className="space-y-6 text-sm font-body">
                <div className="flex items-start">
                  <div className="bg-midnight-black/60 p-2 rounded-lg border border-soft-neon-glow/30 mr-4">
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-midnight-black/60 p-3 rounded-lg border border-soft-neon-glow/30 text-soft-neon-glow/70 hover:text-electric-blue hover:border-electric-blue/60 transition-all hover:shadow-glow-soft">
