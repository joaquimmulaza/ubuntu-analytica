    ...
    <section id="processos" className="relative py-24 text-white overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start relative">
          ...
          <div className="hidden md:block absolute top-12 left-0 w-full h-0.5 bg-gray-700/50 -z-10"></div>
          ...
          {steps.map((step, index) => (
            ...
            >
              {/* Step Number Bubble */}
              <div className="w-10 h-10 rounded-full bg-[#6366f1] flex items-center justify-center font-bold text-white mb-4 shadow-lg shadow-indigo-500/30 z-10">
                {step.id}
              </div>

              {/* Icon Box */}
              <div className="w-20 h-20 bg-gray-800/50 backdrop-blur-sm rounded-xl flex items-center justify-center mb-6 border border-gray-700 hover:border-[#6366f1] transition-colors duration-300 group">
        ...
        <motion.div
          className="mt-20 relative rounded-2xl overflow-hidden bg-white/10 backdrop-blur-md border border-white/20 shadow-2xl max-w-5xl mx-auto"
        ...
        >
          <div className="py-12 px-6 text-center">
            ...
            <a
              href="https://forms.office.com/e/SnBMVQ6TLv"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center bg-[#6366f1] hover:bg-[#5558dd] text-white font-semibold py-3 px-8 rounded-full transition-all duration-300 shadow-lg hover:shadow-indigo-500/50"
            >
